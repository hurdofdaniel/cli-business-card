...
const stringWidth = __nccwpck_require__(537)
...
const stripAnsi = __nccwpck_require__(411);
const isFullwidthCodePoint = __nccwpck_require__(882);
const emojiRegex = __nccwpck_require__(652);
...
const cliBoxes = __nccwpck_require__(94);
...
var eastasianwidth = __nccwpck_require__(61);
// EXTERNAL MODULE: ./node_modules/emoji-regex/index.js
var emoji_regex = __nccwpck_require__(212);
...
var cli_boxes = __nccwpck_require__(733);
...
var ansi_align = __nccwpck_require__(225);
...
function ansi_styles_assembleStyles() {
	...
	styles.color.ansi = ansi_styles_wrapAnsi16();
	styles.color.ansi256 = ansi_styles_wrapAnsi256();
	styles.color.ansi16m = ansi_styles_wrapAnsi16m();
	styles.bgColor.ansi = ansi_styles_wrapAnsi16(ansi_styles_ANSI_BACKGROUND_OFFSET);
	styles.bgColor.ansi256 = ansi_styles_wrapAnsi256(ansi_styles_ANSI_BACKGROUND_OFFSET);
	styles.bgColor.ansi16m = ansi_styles_wrapAnsi16m(ansi_styles_ANSI_BACKGROUND_OFFSET);
...
/* harmony default export */ const node_modules_ansi_styles = (ansi_styles_ansiStyles);
...
const terminalColumns = () => {
	const {env, stdout, stderr} = external_node_process_namespaceObject;
...
const sanitizeOptions = options => {
	...
	if (options.fullscreen && external_node_process_namespaceObject.stdout) {
		let newDimensions = [external_node_process_namespaceObject.stdout.columns, external_node_process_namespaceObject.stdout.rows];
...
const data = {
    name: source.bold.blue("Daniel Hurd"),
    handle: source.white("@HurdOfDaniel"),
    bio: `${source.white("Student from")} ${source.bold.green("New Zealand")}`,
    github: source.gray("https://github.com/") + source.green("hurdofdaniel"),
    web: source.cyan("https://daniel.hurd.nz"),
    labelGitHub: source.white.bold("GitHub:"),
    labelWeb: source.white.bold("Web:"),
};
...
/* harmony default export */ const data_0 = (meData);
;// CONCATENATED MODULE: ./card.js
